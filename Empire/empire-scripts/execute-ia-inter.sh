...
launch_xterm "pypy ./empire-captain-origin/ai${IA1}.py localhost ${PPORT1} > out_P1 2>&1" PPID1
...
##launch_xterm "python2.7 -m cProfile -o prof.out ./empire-captain/ai${IA2}.py localhost ${PPORT2} > out_P2 2>&1" PPID2
launch_xterm "pypy ./empire-captain/ai${IA2}.py localhost ${PPORT2} > out_P2 2>&1" PPID2
